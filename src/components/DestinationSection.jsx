...
export default function DestinationSection({ variant = "slider" }) {
  const destinations = [
    ...
    { name: "Lal Tibba", image: "/uploads/laal-tibba.jpg" },
    { name: "Camel Back Road", image: "/uploads/camel-back.jpg" },
    { name: "Cloud’s End", image: "/uploads/cloud-end.jpg" },
    { name: "George Everest", image: "/uploads/george-everest.jpg" },
    { name: "Bhatta Falls", image: "/uploads/bhatta-fall.jpg" },
    { name: "Mussoorie Lake", image: "/uploads/mussoorie-jheel.jpg" },
    { name: "Jharipani Falls", image: "/uploads/jharipani-falls.jpg" },
